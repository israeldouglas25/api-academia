...
public interface IAvaliacaoFisicaService {
     ...
     *
     * @param avaliacaoFisicaDto - dto referente aos dados para criação da Avaliação Física no banco de dados.
     ...
     * @param avaliacaoFisica - dto referente aos dados necessários para atualização da Avaliação
     *                        Física no banco de dados.
     * @return - Avaliação Física recém-atualizada.
     */
    AvaliacaoFisicaUpdateDto update(Long id, AvaliacaoFisica avaliacaoFisica);
